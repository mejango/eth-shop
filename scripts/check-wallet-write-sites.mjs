...
// eth.shop has no Relayr, Safe-signature, or Permit2 module — the only
// reviewed hook boundary is the direct/Safe write wrapper.
...
if (manifest.format !== "eth-shop-wallet-write-sites-1") {
...
if (rawBoundaryViolations.length) {
  failures.push(
    `Raw wallet access is only allowed inside the reviewed boundary:\n${rawBoundaryViolations
