...
// Client-safe IPFS gateway (matches the CSP img-src allowlist).
const IPFS_GATEWAY = "https://juicebox.center/ipfs/";

function ipfsUriToGatewayUrl(value: string): string {
...
function safeImageSrc(value: string): string | undefined {
  ...
  return protocol === "ipfs:" ? ipfsUriToGatewayUrl(value) : value;
}
